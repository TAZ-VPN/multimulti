...
wget -qc -O /usr/bin/bbr "https://raw.githubusercontent.com/TAZ-VPN/multimulti/main/ssh/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
sleep 1
echo -e "[ ${green}INFO${NC} ] Downloading files... "
wget -qc -O /usr/bin/auto-set "https://raw.githubusercontent.com/TAZ-VPN/multimulti/main/xray/auto-set.sh" && chmod +x /usr/bin/auto-set 
wget -qc -O /usr/bin/crtxray "https://raw.githubusercontent.com/TAZ-VPN/multimulti/main/xray/crt.sh" && chmod +x /usr/bin/crtxray 
sleep 1
