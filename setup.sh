...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/TAZ-VPN/permission/main/ipmini > /root/tmp
...
# https://raw.githubusercontent.com/TAZ-VPN/permission/main/ipmini 
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/TAZ-VPN/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/TAZ-VPN/permission/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
    res="Permission Denied! Please Contact Admin t.me/Tazpin"
    fi
    BURIQ
}
...
red " Permission Denied! Please Contact Admin t.me/Tazpin "
...
echo ""
wget -qc https://raw.githubusercontent.com/TAZ-VPN/multimulti/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
echo "----------------------------------------------------------------------------------"
...
sleep 1
wget -qc https://raw.githubusercontent.com/TAZ-VPN/multimulti/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install Install XRAY!"
sleep 2
wget -qc https://raw.githubusercontent.com/TAZ-VPN/multimulti/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
echo -e "$green[INFO]$NC SET BR"
sleep 2
wget -qc https://raw.githubusercontent.com/TAZ-VPN/multimulti/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
echo -e "$green[INFO]$NC Install SSH WS"
sleep 2
wget -qc https://raw.githubusercontent.com/TAZ-VPN/multimulti/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
echo -e "$green[INFO]$NC Install SSH Non TLS"
sleep 2
wget -qc https://raw.githubusercontent.com/TAZ-VPN/multimulti/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
echo -e "$green[INFO]$NC Install SSH Slow DNS"
sleep 2
wget -qc https://raw.githubusercontent.com/TAZ-VPN/multimulti/main/slowdnss/install-sldns.sh && chmod +x install-sldns.sh && ./install-sldns.sh
echo -e "$green[INFO]$NC Install Update"
sleep 2
echo -e "$green[INFO]$NC Download Extra Menu"
wget -qc https://raw.githubusercontent.com/TAZ-VPN/multimulti/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
cat> /root/.profile << END
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/TAZ-VPN/permission/main/version  )
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Created By Taz-vpn ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
