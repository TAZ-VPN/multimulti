...
itoken=$(curl -sS https://raw.githubusercontent.com/TAZ-VPN/permission/main/asi)

MYIP=$(curl -sS ipv4.icanhazip.com)
NameUser=$(curl -sS https://raw.githubusercontent.com/TAZ-VPN/permission/main/ipmini | grep $MYIP | awk '{print $2}')
