...
Isadmin=$(curl -sS https://raw.githubusercontent.com/TAZ-VPN/permission/main/ipmini | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/TAZ-VPN/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
